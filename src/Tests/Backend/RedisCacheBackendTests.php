...
/**
 * A tests class for RedisCacheBackend.
 *
 **/
class RedisCacheBackendTests {
	
	private function GetCache() {
		
		return new \EggCup\Backend\RedisCacheBackend(new \Predis\Client(array('host' => '127.0.0.1', 'port' => 6379)));
